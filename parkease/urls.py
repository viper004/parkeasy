...
urlpatterns = [
    ...
    path('admin/members/<int:member_id>/update/', views.update_member, name="update_member"),
    ...
    path('admin/vehicles/<int:vehicle_id>/update-slot/', views.update_vehicle_slot, name="update_vehicle_slot"),
    path('admin/vehicles/<int:vehicle_id>/delete/', views.admin_delete_vehicle, name="admin_delete_vehicle"),
